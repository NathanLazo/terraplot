...
const stats = [
  ...
  { name: "Average deploy time", value: "24", unit: "sec" },
        ...
        <main>
          <header>
            ...
            <div className="flex flex-col items-start justify-between gap-x-8 gap-y-4 bg-gray-700/10 px-4 py-4 sm:flex-row sm:items-center sm:px-6 lg:px-8">
              ...
              <div className="order-first flex-none rounded-full bg-indigo-600/10 px-2 py-1 text-xs font-medium text-indigo-600 ring-1 ring-inset ring-indigo-600/30 sm:order-none">
                Production
              </div>
            </div>
