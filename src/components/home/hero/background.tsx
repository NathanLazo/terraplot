...
const background: FC = () => {
  return (
    <>
      <svg
        className="absolute inset-0 -z-10 h-full w-full stroke-white/10 opacity-30 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]"
        aria-hidden="true"
      >
        <defs>
          <pattern
        ...
        <svg x="50%" y={-1} className="overflow-visible fill-gray-800/10">
          <path
