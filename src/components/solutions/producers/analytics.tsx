const stats = [
  { id: 1, name: "Inversiones finalizadas ", value: "200+" },
  { id: 2, name: "De productores sastifechos", value: "99.9%" },
  { id: 3, name: "Transparente", value: "100%"  },
  { id: 4, name: "En ingresos netos ", value: "Hasta 300K en USDC" },
];
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
          <h2 className="text-base font-semibold leading-8 text-indigo-600">
            Consigue inversores para tus parcelas
          </h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">
            De forma facil, confiable y &nbsp; Transparente
           </p>
          <p className="mt-6 text-lg leading-8 text-gray-300">
            Gracias a la blockchain, Terraplot permite a los productores agrícolas a 
            financiar sus parcelas de forma descentralizada.
          </p>
        </div>
